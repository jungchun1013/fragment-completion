...
Usage:
    uv run python -m experiments.exp2.clip_interp zeroshot --max-images 5
    uv run python -m experiments.exp2.clip_interp --model L-14 patch
    uv run python -m experiments.exp2.clip_interp all
"""
...
_RESULTS_BASE: Path = Path("results/exp2/clip_interp")
...
def main() -> None:
    ...
    shared.add_argument("--results-dir", default=None,
